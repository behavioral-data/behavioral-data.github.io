...
The homepage now combines two people honors, two news items and two awarded papers. The two added 2026 news items use the maintainer’s confirmation of Jina’s return as co-PI and Ken’s break to join xAI. Year ranges are preserved where the award source specifies a tenure or academic year.
