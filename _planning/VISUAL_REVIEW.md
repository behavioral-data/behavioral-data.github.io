...
## Approved divider revision — September 10, 2026

Following comparison of three isolated previews, the maintainer selected dividers extending from the sidebar to the right page edge (full screen width on phones). The sidebar and horizontal rules share 1px thickness and color #c8bfd8. Latest news, Latest people awards, and Latest paper awards are independent sections, with no Group highlights wrapper. Latest publications has a count-aware “See all … papers” link in its heading instead of a separate bottom link. Every latest-content section has a right-aligned archive link. The sidebar retains its original line breaks; duplicated breaks were confined to the disposable preview conversion. Push and deployment authorized.
