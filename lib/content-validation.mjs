...
export function validateContent(data, assetExists = () => true) {
  ...
  for (const o of data.opportunities) {
    for (const field of ['title','ownerId','url','description','actionLabel']) text(o[field], `${o.id}.${field}`);
    ...
    if (o.sourceLabel) { text(o.sourceLabel, `${o.id}.sourceLabel`); if (!o.sourceUrl) fail(o.id, 'sourceLabel needs sourceUrl'); }
